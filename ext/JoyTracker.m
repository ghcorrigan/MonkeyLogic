classdef JoyTracker < Tracker
    ...
    methods (Access = protected)
        function create_tracer(obj)
            ...
            destroy_tracer(obj);
            obj.Screen.JoystickCursor(1) = load_cursor(obj.TracerImage,obj.TracerShape,obj.TracerColor,obj.TracerSize,9);
            obj.Screen.JoystickCursor(2) = load_cursor(obj.TracerImage,obj.TracerShape,obj.TracerColor,obj.TracerSize,10);
            mglactivategraphic(obj.Screen.JoystickCursor,false);
        end
