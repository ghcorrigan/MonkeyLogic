...
switch nargin
    case 1, colorkey = default_colorkey; devices = 3;
    case 2, if isscalar(varargin{2}), devices = varargin{2}; colorkey = default_colorkey; else devices = 3; colorkey = varargin{2}; end
    case 3, if isscalar(varargin{2}), devices = varargin{2}; colorkey = varargin{3}; else colorkey = varargin{2}; devices = varargin{3}; end
end
...
if ischar(varargin{1})
    ...
    id = mdqmex(7, filename, colorkey, devices);
else
    bits = varargin{1};
    ...
    id = mdqmex(7, sz([2 1 3]), bits, colorkey, devices);
end
