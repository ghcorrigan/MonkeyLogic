...
while idx < nargin
    ...
    try
        switch type{1}
            ...
            case 'LINE'
                switch method
                    case 'addpoint', mdqmex(22,id,method,cast(varargin{idx}','uint32')); idx = idx + 1;
                    case 'color'
            ...
            case 'TEXT'
                switch method
                    ...
                    case {'text','halign','valign','fontface','fontsize'}, mdqmex(22,id,method,varargin{idx}); idx = idx + 1;
                    case 'font'
